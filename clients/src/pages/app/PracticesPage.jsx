...
export default function PracticesPage() {
  ...
  return (
    <div
      key={p.practiceId}
      className="relative h-[390px] overflow-hidden rounded-[34px] shadow-md"
    >
      {/* Background image */}
      <img
        src={imgSrc}
      ...
      <div className="absolute right-4 top-4 z-10 rounded-full bg-white/20 px-3 py-1 text-[11px] font-semibold text-white backdrop-blur">
        by {p.authorName || "Community member"}
      </div>

      {/* Content block sits LOWER (like sample) */}
      <div className="absolute left-5 right-5 bottom-[92px] z-10 text-left">
        ...
        <p className="mt-2 text-[13px] leading-snug text-white/85">
          {p.description || "Community practice shared with full context and steps."}
        </p>
