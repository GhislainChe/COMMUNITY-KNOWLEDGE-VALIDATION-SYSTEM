...
export default function PracticesPage() {
  ...
  return (
    <div className="space-y-3 px-3 py-3 text-slate-900 dark:text-slate-100 sm:px-4 md:px-6">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        ...
        <button
          ...
          className="w-full rounded-xl bg-emerald-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-emerald-700 sm:w-auto"
        >
          Add Practice
        </button>
      </div>
      ...
      {practices.length === 0 ? (
        <p className="mt-3 text-slate-500">No practices found.</p>
      ) : (
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {practices.map((p) => {
            ...
            return (
              <div
                key={p.practiceId}
                className="relative h-[360px] overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-md transition-shadow hover:shadow-lg dark:border-white/10 dark:bg-white/10 dark:shadow-black/30 sm:h-[390px] sm:rounded-[28px]"
              >
                <img
                  src={imgSrc}
                  alt={p.title}
                ...
                <div className="absolute bottom-[68px] left-2 right-2 z-10 text-left sm:bottom-[75px]">
                  <h2 className="font-heading text-[22px] font-extrabold leading-tight text-white sm:text-[24px]">
                    {p.title}
                  </h2>
                ...
                <div className="absolute bottom-2 left-2 right-2 z-10 sm:bottom-3 sm:left-3 sm:right-3">
                  <button
                    ...
                    className="w-full rounded-full bg-white px-4 py-2 text-[13px] font-semibold text-slate-900 shadow-sm transition hover:bg-slate-100 dark:bg-emerald-600 dark:text-white dark:hover:bg-white"
                  >
                    View details
                  </button>
                </div>
      ...
      {addOpen && (
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-2 sm:p-4">
          ...
          <div className="relative w-full max-w-2xl overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-xl dark:border-white/10 dark:bg-[#0b1220] sm:rounded-3xl">
      ...
      {openPracticeId && (
        <div className="fixed inset-0 z-50 flex items-end justify-center p-2 sm:items-center sm:p-4">
          ...
          <div className="relative w-full max-w-lg rounded-2xl border border-slate-200 bg-white p-3 shadow-xl dark:border-white/10 dark:bg-[#0b1220] sm:rounded-3xl sm:p-5">
            ...
            <form onSubmit={submitOutcome} className="mt-3 space-y-3 sm:mt-4 sm:space-y-4">
              <div className="grid gap-3 sm:grid-cols-2">
                <div>
                  <label className="text-xs font-semibold text-slate-600 dark:text-slate-300/70">
                    Outcome type
              ...
              <div className="flex flex-col-reverse gap-2 sm:flex-row sm:items-center sm:justify-end">
                ...
                <button
                  ...
                  className="w-full rounded-2xl bg-emerald-600 px-4 py-2 text-sm font-semibold text-white hover:bg-emerald-700 disabled:opacity-70 sm:w-auto"
                >
