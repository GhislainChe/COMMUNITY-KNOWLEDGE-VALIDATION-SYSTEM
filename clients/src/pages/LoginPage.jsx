    ...
    <span className="font-sans text-sm font-normal text-slate-500">
      ...
      <div className="mx-auto flex max-w-6xl justify-center px-4 pb-12">
        <div className="w-full max-w-xl">
          {/* Header (avatar + title like your sample) */}
          ...
          {/* Social buttons OUTSIDE the big card (like the sample) */}
          ...
          {/* Big card ONLY for the form (like the sample) */}
          <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl dark:border-white/10 dark:bg-white/5 sm:p-8">
            <form onSubmit={onSubmit} className="space-y-5">
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <button
                  type="button"
                  className="text-slate-500 hover:text-slate-700 dark:text-slate-300/70 dark:hover:text-slate-200"
                  onClick={() => setMsg("Forgot password not implemented yet")}
                >
                  Forgot password?
                </button>
              </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full rounded-2xl bg-violet-600 py-3 text-sm font-semibold text-white shadow-lg shadow-violet-600/20 hover:bg-violet-700 disabled:opacity-60"
              >
          ...
          {/* Footer link like sample */}
          <p className="mt-6 text-center text-sm text-slate-500 dark:text-slate-300/70">
            Don’t have an account?{" "}
            <a className="font-semibold text-violet-600 hover:underline" href="/register">
              Sign up
            </a>
          </p>
        </div>
